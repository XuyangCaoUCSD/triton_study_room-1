...
socket.on('connect', () => {
    ...
    // Need a way to identify this machine to whomever is connected
    ...
    for (let key in nI) {
        ...
        // So only have limited number of machines in local DB, but for deployment remove this code
    ...
    socket.emit('clientAuth', '5jaldfa8923jnlk9fvqpnc902fs');
